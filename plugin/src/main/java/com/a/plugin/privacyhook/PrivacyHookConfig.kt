...
//        FieldInsnNode(Opcodes.GETSTATIC, "android/os/Build", "SERIAL", "Ljava/lang/String;")
    ...
    init {
        hooks.putAll(
            mutableMapOf(
                getSimCountryIso to MethodHookBean(
//                    getSimCountryIso,
                    MethodInsnNode(Opcodes.INVOKESTATIC,"com/webuy/common/utils/privacy/TelephonyManagerUtil","getSimCountryIso","()Ljava/lang/String;"),
                    mutableSetOf("*"),
                    mutableSetOf("com.webuy.common.utils.privacy.*")
                ),
                Secure_getString to MethodHookBean(
                    MethodInsnNode(Opcodes.INVOKESTATIC,"com/webuy/common/utils/privacy/AndroidIdUtil","getAndroidId","()Ljava/lang/String;"),
                    mutableSetOf("*"),
                    mutableSetOf("com.webuy.common.utils.privacy.*")
                )
            )
